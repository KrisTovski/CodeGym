...
public class Solution {
    ...
    public void calculateAndSetValue3(long value) {
        ...
        if (value > Integer.MAX_VALUE) {
            ...
            logger.debug("calculateAndSetValue3 set value1 (value > Integer.MAX_VALUE): " + value1);
        } else {
            value1 = (int) value;
            logger.debug("calculateAndSetValue3 set value1: " + value1);
        }
    }
    ...
    public void divide(int number1, int number2) {
        ...
        try {
            ...
            logger.error("Some Arithmetic Exception", e);
        }
    }
